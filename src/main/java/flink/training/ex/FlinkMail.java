...
public class FlinkMail {
	...
	public static void main(String[] args) throws Exception {
		...
		DataSet<Tuple2<String, String>> timestampSender = env
				.readCsvFile(
						"/Users/Shanghai/Developer/Flink/quickstart/dataset/flinkMails.gz")
				.lineDelimiter("##//##").fieldDelimiter("#|#")
				.includeFields("011").types(String.class, String.class);

		// get the month and the sender email
		DataSet<Tuple3<String, String, Integer>> output = timestampSender
				.map(new MailProcessor()) // map (month, sender) to (month, sender, 1)
